...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/icon/logo_sdit_annahl.png') ?>" type="image/png" sizes="32x32">
    <link rel="apple-touch-icon" href="<?= base_url('assets/icon/logo_sdit_annahl.png') ?>">
